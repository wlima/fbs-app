...
@section('content')
    <!-- component -->
    <div class="relative max-w-md mx-auto md:max-w-2xl mt-10 min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-xl mt-16">
        <div class="px-6">
            ...
            <div class="text-center mt-2">
                <h3 class="text-2xl text-slate-700 font-bold leading-normal mb-1">{{$me->name}}</h3>
                <div class="text-xs mt-0 mb-2 text-slate-400 font-bold uppercase">
                    <i class="bi bi-envelope-check mr-2 text-slate-400 opacity-75"></i>{{$me->email}}
                </div>
            </div>
